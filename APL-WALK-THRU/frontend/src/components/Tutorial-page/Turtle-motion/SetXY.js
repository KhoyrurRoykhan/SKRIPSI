...
import map from './assets/4-setx-sety.png';
...
const SetXY = () => {
  ...
  const showHint = () => {
    swal(
      ...
      "Tugas kalian adalah memindahkan posisi Bidawang menuju ke posisi cacing dengan menggunakan perintah setx dan sety. \n\n",
      "info"
    );
  };
  ...
  const handleSubmit = () => {
    const feedbackMessages = {
      question1: answers.question1 === 'Posisi baru menjadi (200, 50).' 
        ? 'Benar!' 
        : 'Salah!',
      question2: answers.question2 === 'sety(-50)' 
        ? 'Benar!' 
        : 'Salah!'
    };
...
`);
  ...
  return (
    <div className='content' style={{paddingLeft:50, paddingRight:50}}>
      <div>
        <h2 style={{textAlign:'center'}}>Setx & Sety</h2>
        <hr></hr>
        <br/>

        <h4>Tujuan Pembelajaran</h4>
        <ol>
          <li>Memahami cara mengatur posisi bidawang pada sumbu x dan y secara terpisah menggunakan `setx()` dan `sety()`.</li>
        </ol>
...
sety(150)`}
        ...
        <h4>Latihan Menggunakan setx() dan sety()</h4>
        <p>
          ...
          <Accordion.Body>
            <Form>
              <Form.Group controlId="question1">
                <Form.Label>1. Apa hasil dari perintah setx(200) jika posisi awal turtle adalah (100,50)? </Form.Label>
                <Form.Check 
                  type="radio" 
                  label="Posisi baru menjadi (200, 50)." 
                  name="question1" 
                  onChange={() => handleAnswerChange('question1', 'Posisi baru menjadi (200, 50).')} 
                />
                <Form.Check 
                  type="radio" 
                  label="Posisi baru menjadi (100, 200)." 
                  name="question1" 
                  onChange={() => handleAnswerChange('question1', 'Posisi baru menjadi (100, 200).')} 
                />
                <Form.Check 
                  type="radio" 
                  label="Posisi baru menjadi (200, 200)." 
                  name="question1" 
                  onChange={() => handleAnswerChange('question1', 'Posisi baru menjadi (200, 200).')} 
                />
                <Form.Check 
                  type="radio" 
                  label="Posisi baru tetap (100, 50). " 
                  name="question1" 
                  onChange={() => handleAnswerChange('question1', 'Posisi baru tetap (100, 50). ')} 
                />
              </Form.Group>
              {feedback.question1 && <Alert variant={feedback.question1 === 'Benar!' ? 'success' : 'danger'}>{feedback.question1}</Alert>}

              <Form.Group controlId="question2">
                <Form.Label>2. Jika Anda ingin memindahkan turtle secara vertikal ke posisi y = -50 tanpa mengubah posisi x, perintah apa yang harus digunakan?</Form.Label>
                <Form.Check 
                  type="radio" 
                  label="sety(-50)" 
                  name="question2" 
                  onChange={() => handleAnswerChange('question2', 'sety(-50)')} 
                />
                <Form.Check 
                  type="radio" 
                  label="setx(-50)" 
                  name="question2" 
                  onChange={() => handleAnswerChange('question2', 'setx(-50)')} 
                />
                <Form.Check 
                  type="radio" 
                  label="setposition(-50, 0)" 
                  name="question2" 
                  onChange={() => handleAnswerChange('question2', 'setposition(-50, 0)')} 
                />
                <Form.Check 
                  type="radio" 
                  label="home()" 
                  name="question2" 
                  onChange={() => handleAnswerChange('question2', 'home()')} 
                />
              </Form.Group>
