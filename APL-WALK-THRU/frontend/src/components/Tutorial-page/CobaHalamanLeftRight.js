...
const CobaHalamanLeftRight = () => {
  ...
  const activeAccordionKey = location.pathname.includes("/turtlemotion") || location.pathname.includes("/cobasidebar/leftright")
    ? "1"
    : "0";
            ...
            <Accordion.Item eventKey="1">
              ...
              <Accordion.Body>
                <div className="d-flex flex-column">
                  ...
                  <button
                    className={getButtonClass("/turtlemotion/forwardbackward")}
...
export default CobaHalamanLeftRight;
