...
const Clear = () => {
    ...
    const handleSubmit = () => {
      const feedbackMessages = {
        question1: answers.question1 === 'clear() menghapus gambar tanpa mengubah posisi atau atribut, sedangkan reset() juga mengatur ulang posisi dan atribut bidawang.' 
          ? 'Benar!' 
          : 'Salah!',
        question2: answers.question2 === 'Biru.' 
          ? 'Benar!' 
          : 'Salah!'
      };
...
forward(100) # Memulai gambar baru dari posisi terakhir `}
        ...
        <h4>Latihan Menggunakan clear()</h4>
        <p>
          ...
          <Accordion.Body>
            <Form>
              <Form.Group controlId="question1">
                <Form.Label>1. Apa perbedaan utama antara fungsi clear() dan reset()?</Form.Label>
                <Form.Check 
                  type="radio" 
                  label="clear() menghapus gambar tanpa mengubah posisi atau atribut, sedangkan reset() juga mengatur ulang posisi dan atribut bidawang." 
                  name="question1" 
                  onChange={() => handleAnswerChange('question1', 'clear() menghapus gambar tanpa mengubah posisi atau atribut, sedangkan reset() juga mengatur ulang posisi dan atribut bidawang.')} 
                />
                <Form.Check 
                  type="radio" 
                  label="clear() menghapus gambar beserta posisi bidawang, sedangkan reset() hanya menghapus gambar." 
                  name="question1" 
                  onChange={() => handleAnswerChange('question1', 'clear() menghapus gambar beserta posisi bidawang, sedangkan reset() hanya menghapus gambar.')} 
                />
                <Form.Check 
                  type="radio" 
                  label="clear() tidak menghapus gambar, sedangkan reset() menghapus gambar." 
                  name="question1" 
                  onChange={() => handleAnswerChange('question1', 'clear() tidak menghapus gambar, sedangkan reset() menghapus gambar.')} 
                />
                <Form.Check 
                  type="radio" 
                  label="clear() menutup jendela, sedangkan reset() tidak." 
                  name="question1" 
                  onChange={() => handleAnswerChange('question1', 'clear() menutup jendela, sedangkan reset() tidak.')} 
                />
              </Form.Group>
              ...
              <Form.Group controlId="question2">
                ...
                <Form.Check 
                  type="radio" 
                  label='Tidak Berwarna.' 
                  name="question2" 
                  onChange={() => handleAnswerChange('question2', 'Tidak Berwarna.')} 
                />
                <Form.Check 
                  type="radio" 
                  label='Biru.'
