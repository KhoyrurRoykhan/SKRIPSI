      ...
      <Row>
        ...
        <Col xs={10} className="p-4">
          <div>
            ...
            <ul>
              <li>Nilai kelulusan minimum: 80%</li>
              <li>Durasi pengerjaan: 15 menit</li>
            </ul>
            <p>
              Jika Anda belum mencapai nilai kelulusan, Anda harus menunggu selama 1 menit sebelum dapat mengulang kuis. Gunakan waktu tunggu tersebut untuk mempelajari kembali materi sebelumnya, ya!
            </p>
